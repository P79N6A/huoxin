package com.daimeng.livee.broadcast;
...
public class PushReceiver extends BroadcastReceiver {
	...
	public static final String PUSH_LIVE_INFO = "PUSH_LIVE_INFO";
	public static final String PUSH_LIVE_INFO_BOUND = "PUSH_LIVE_INFO_BOUND";
	...
	public void onReceive(Context context, Intent intent) {
        ...
        if (JPushInterface.ACTION_REGISTRATION_ID.equals(intent.getAction())) {
			...
			try {
				...
				LiveBean u = new Gson().fromJson(extra.getString("live_info"),LiveBean.class);
				//打开自定义的Activity
				Intent i = new Intent(context, MainActivity.class);
				Bundle bd = new Bundle();
				bd.putParcelable(PUSH_LIVE_INFO,u);
				i.putExtra(PUSH_LIVE_INFO_BOUND,bd);
				i.putExtras(bundle);
