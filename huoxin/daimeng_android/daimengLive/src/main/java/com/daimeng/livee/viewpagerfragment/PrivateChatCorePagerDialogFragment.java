...
import com.daimeng.livee.adapter.UserBaseInfoPrivateChatAdapter;
...
import com.daimeng.livee.fragment.MessageDetailDialogFragment;
...
public class PrivateChatCorePagerDialogFragment extends DialogFragment implements View.OnClickListener {
    ...
    private void onPrivateChatItemClick(int position) {
        ...
        messageFragment.setDialogInterface(new com.daimeng.livee.interf.DialogInterface() {
            @Override
