...
public class SimpleUtils {
    ...
    * */
    public static void loadImageForView(Context context,ImageView imageView, String url, int def){
        ...
        DrawableRequestBuilder<String> drawableRequestBuilder = Glide.with(context).load(LiveUtils.getHttpUrl(url)).dontAnimate();
    ...
    * 简单的加载图片,依赖Glide
    * */
    public static void loadGifImageForView(Context context,ImageView imageView, String url, int def){
