...
public class LineControllerView extends LinearLayout {
    ...
    private void setUpView(Context context){
        ...
        iconv = (ImageView) findViewById(R.id.ctl_icon);
        if(icon != -1){
    ...
    public void setCanNavImg(Context context,String url){
        iconv.setVisibility(VISIBLE);
        SimpleUtils.loadImageForView(context,iconv,url,0);
    }

    //是否显示更多
    public void setMoreVisible(boolean isVisible){
        navArrow.setVisibility(isVisible ? VISIBLE:GONE);
    }
}
