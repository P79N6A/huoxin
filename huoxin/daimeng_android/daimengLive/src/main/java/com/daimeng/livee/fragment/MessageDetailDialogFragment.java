...
import com.daimeng.livee.interf.ListenMessage;
...
import com.daimeng.livee.adapter.MessageAdapter;
import com.daimeng.livee.bean.PrivateChatUserBean;
import com.daimeng.livee.bean.PrivateMessage;
...
public class MessageDetailDialogFragment extends DialogFragment implements ListenMessage{
    ...
    private com.daimeng.livee.interf.DialogInterface mDialogInterface;
    ...
    private void sendPrivateChat() {
        ...
        if(StringUtils.toInt(AppContext.getInstance().getLoginUser().level) < StringUtils.toInt(pConfigBean.private_chat_limit)){
            AppContext.showToast(String.format(Locale.CHINA,"等级达到%s才可以私信",pConfigBean.private_chat_limit));
            return;
        }
    ...
    public void setDialogInterface(com.daimeng.livee.interf.DialogInterface dialogInterface){
