 ...
 */
package com.daimeng.livee.ui.customviews;
...
import com.daimeng.livee.base.AbstractPathAnimator;
import com.daimeng.livee.base.PathAnimator;
...
public class HeartLayout extends RelativeLayout {
    ...
    private void findViewById(Context context) {
        ...
        Bitmap bitmap = BitmapFactory.decodeResource(getResources(), R.drawable.live_button_like);
    ...
    private static int[] drawableIds = new int[]{R.drawable.plane_heart_cyan, R.drawable.plane_heart_pink, R.drawable.plane_heart_red, R.drawable.plane_heart_yellow,R.drawable.plane_heart_cyan};
