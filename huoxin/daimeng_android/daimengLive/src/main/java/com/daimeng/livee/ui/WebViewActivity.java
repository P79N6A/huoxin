...
import com.daimeng.livee.utils.JavaScriptInterface;
...
public class WebViewActivity extends BaseActivity implements View.OnClickListener {
    ...
    public void initView() {
        ...
        wv.addJavascriptInterface(new JavaScriptInterface(), "JavaScriptInterface");
        ...
        wv.setWebViewClient(new WebViewClient() {
            ...
            public boolean shouldOverrideUrlLoading(WebView view, String url) {
                ...
                if (url.startsWith("live:")) {
                    //复制分享Url
                    if (Uri.parse(url).getQueryParameter("action").equals("copy_share_url")) {

                        TDevice.copyTextToBoard(AppConfig.MAIN_URL + "/index.php?g=Appapi&m=login&a=index&tid=" + AppContext.getInstance().getLoginUid());
                        return true;
                    } else if (Uri.parse(url).getQueryParameter("action").equals("copy_code")) {

                        TDevice.copyTextToBoard(Uri.parse(url).getQueryParameter("cid"));
                        return true;
                    }
                }
