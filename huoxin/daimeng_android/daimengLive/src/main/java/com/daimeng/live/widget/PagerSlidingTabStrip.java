package com.daimeng.live.widget;
...
import com.daimeng.live.interf.PagerSlidingInterface;
...
public class PagerSlidingTabStrip extends HorizontalScrollView {
    ...
    private int tabTextColor = 0xFF111111;
    ...
    public PagerSlidingTabStrip(Context context, AttributeSet attrs, int defStyle) {
        ...
        HorizontalScrollView.LayoutParams params = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT);
    ...
    private void addTextTab(final int position, String title) {
        //Typeface font = Typeface.createFromAsset(context.getAssets(), "heitifont.ttc");
        ...
        tab.setIncludeFontPadding(true);
        tab.setLeft(tabPadding);
        ...
        tab2.setLeft(tabPadding);
        tab2.setSingleLine();
        tab2.setIncludeFontPadding(true);
