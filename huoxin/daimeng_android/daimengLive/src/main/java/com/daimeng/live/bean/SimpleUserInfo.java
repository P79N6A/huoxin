...
/**
 * Created by daimeng on 2017/1/18.
 */
...
public class SimpleUserInfo implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(this.custombackground);
        dest.writeString(this.guardicon);
    }
    ...
    protected SimpleUserInfo(Parcel in) {
        ...
        this.custombackground = in.readString();
        this.guardicon = in.readString();
    }
