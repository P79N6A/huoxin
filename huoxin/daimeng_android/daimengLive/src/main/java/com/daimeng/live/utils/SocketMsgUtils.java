...
/**
 * Created by daimeng on 2016/12/26.
 */
...
public class SocketMsgUtils {
    ...
    private LinkedTreeMap<String, String> list2 = new LinkedTreeMap<>();
    ...
    public SocketMsgUtils(String json) {
        ...
        try {
            ...
            gift_icon = mContentJson.getString("gift_icon");
    ...
    public String getSex() {
        if (mContentJson != null) {
            try {
                return mContentJson.getString("sex");
            } catch (JSONException e) {
                e.printStackTrace();
            }
        }
    ...
    public void sendMessage(Socket socket) {
        if (socket != null && mMsgJson != null) {
            //TLog.log(mMsgJson.toString());
            socket.emit(IMControl.EVENT_NAME, mMsgJson);
    ...
    public JSONObject getCtObject() {
        try {
            return ct == null ? null : new JSONObject(ct);
        } catch (JSONException e) {
            e.printStackTrace();
        }
        return null;
