package com.daimeng.livee.game.view;
...
import com.daimeng.livee.game.PokersGameControl;
...
public class PokersGameView extends RelativeLayout {
    ...
    private int btiSelectNumImg[] = new int[]{
            R.mipmap.icon_game_betting_10,
            R.mipmap.icon_game_betting_100,
            R.mipmap.icon_game_betting_1000,
            R.mipmap.icon_game_betting_10000,
    };

    private int[] btiSelectNumImgFocus = new int[]{
            R.mipmap.icon_game_betting_10_foucs,
            R.mipmap.icon_game_betting_100_foucs,
            R.mipmap.icon_game_betting_1000_foucs,
            R.mipmap.icon_game_betting_10000_foucs,
    };
    ...
    public PokersGameView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public PokersGameView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public void initGameView() {
        ...
        removeView(mView);
        mView = View.inflate(mContext, R.layout.view_game_pokers, null);

        addView(mView);
        initView(mView);

        if (mGameInterface != null) {
            mGameInterface.onInitGameView();
        }
    ...
    private void init(Context ct) {
        ...
        mContext = ct;
        mView = View.inflate(ct, R.layout.view_game_pokers, null);

        res.put(6, R.mipmap.icon_game_pokers_bz);
        res.put(2, R.mipmap.icon_game_pokers_dz);
        res.put(1, R.mipmap.icon_game_pokers_szdl);
        res.put(3, R.mipmap.icon_game_pokers_sz);
        res.put(4, R.mipmap.icon_game_pokers_th);
        res.put(5, R.mipmap.icon_game_pokers_ths);
    ...
    private void initView(View view) {
        ...
        mTvReadyBg = (TextView) view.findViewById(R.id.tv_game_ready_start);
        ...
        view.findViewById(R.id.rl_game_betting_1).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickBetting(1);
                }
            }
        });
        ...
        view.findViewById(R.id.rl_game_betting_2).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickBetting(2);
                }
            }
        });
        ...
        view.findViewById(R.id.rl_game_betting_3).setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                if (mGameInterface != null) {
                    mGameInterface.onClickBetting(3);
                }
            }
        });
        ...
        mBtnGameStart.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (mGameInterface != null) {
                    mGameInterface.onClickStartGame();
                }
            }
        });
        mBtnGameOver = (Button) view.findViewById(R.id.btn_live_game_over);
        mBtnGameOver.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {

                if (mGameInterface != null) {
                    mGameInterface.onClickGameOver();
                }
            }
        });
                ...
                public void onClick(View view) {
                    ...
                    if (mGameInterface != null) {
                        if (view.getId() == mIvSelectBettingBtn[0].getId())
                            mGameInterface.onSelectBettingNum(10);
                        if (view.getId() == mIvSelectBettingBtn[1].getId())
                            mGameInterface.onSelectBettingNum(100);
                        if (view.getId() == mIvSelectBettingBtn[2].getId())
                            mGameInterface.onSelectBettingNum(1000);
                        if (view.getId() == mIvSelectBettingBtn[3].getId())
                            mGameInterface.onSelectBettingNum(10000);
                    }
    ...
    public void setIsVisibleStartWords() {
        mTvReadyBg.animate().scaleX(0.4f).scaleY(0.4f).setDuration(500).withEndAction(new Runnable() {
            @Override
            public void run() {
                mTvReadyBg.setVisibility(GONE);
            }
        }).start();
    }
    ...
    public void changeBettingCoin(int index, int ownCoin, int totalCoin) {
        ...
        if (index == 1) {
            mTvTotalBetting1.setText(SimpleUtils.simplifyString(totalCoin));
            mTvBetting1.setText(SimpleUtils.simplifyString(ownCoin));
        } else if (index == 2) {
            mTvTotalBetting2.setText(SimpleUtils.simplifyString(totalCoin));
            mTvBetting2.setText(SimpleUtils.simplifyString(ownCoin));
        } else {
            mTvTotalBetting3.setText(SimpleUtils.simplifyString(totalCoin));
            mTvBetting3.setText(SimpleUtils.simplifyString(ownCoin));
        }
    ...
    public void startGame() {
        ...
        if (mGameInterface != null) {
            mGameInterface.onStartGameCommit();
        }
    ...
    private void startLicensing() {
        ...
        if (mGameInterface != null) {
            mGameInterface.onStartLicensing();
        }
        ...
        int margin = (int) TDevice.dpToPixel(20);
        for (int s = 0; s < 3; s++) {
            ...
            while (i < 3) {
                ...
                pokers.setImageResource(R.mipmap.icon_poker_back_goldflower);
        ...
        readyGame(0);
        if (mGameInterface != null) {
            mGameInterface.onStartCountDown();
        }
    ...
    public void readyGame(int i) {
        ...
        mIvReady.setBackgroundResource(R.mipmap.dt);
...
//        mIvReady.animate()
    ...
    public void resultGame() {
        ...
        mIvEnd.setImageResource(R.mipmap.icon_start_game);
    ...
    //显示结果
    public void showResult(final int index, String p1, String p2, String p3, int str, int isWinning) {
        ...
        if (index == 2) {
            ...
            int winImg[] = new int[]{R.mipmap.bg_game_winning_left, R.mipmap.bg_game_winning_center, R.mipmap.bg_game_winning_right};

            mIvGameWinning.setImageResource(winImg[winningIndex]);
        }

        mTvCountDown.setVisibility(GONE);
        String p1Img[][] = new String[3][2];
        ...
        animatorSet.addListener(new Animator.AnimatorListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                if (mGameInterface != null && index == 2) {
                    mGameInterface.onShowResultEnd();
                }
            }
    ...
    public void initGameMenu(boolean isEmcee){
        if(isEmcee){
            ...
            mBtnGameStart.setVisibility(VISIBLE);
        }
    }
}
