...
public class AppConfig {
    //域名
    public static final String MAIN_URL = false ? BuildConfig.API_SERVER_URL_DEBUG : BuildConfig.API_SERVER_URL;
    //api地址
    public static final String MAIN_URL_API = MAIN_URL + "/api/public/";
    //支付宝回调地址
    public static final String AP_LI_PAY_NOTIFY_URL = MAIN_URL + "/alipay_app/notify_url.php";
