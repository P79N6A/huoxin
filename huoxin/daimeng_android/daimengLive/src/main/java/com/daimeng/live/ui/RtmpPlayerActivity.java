...
import com.daimeng.live.bean.LiveEnterRoomBean;
import com.daimeng.live.bean.LiveGameUrlBean;
import com.daimeng.live.bean.SendGiftBean;
import com.daimeng.live.bean.UserBean;
import com.daimeng.live.bean.callback.CallBackSendGift;
import com.daimeng.live.business.LiveTimeBusiness;
import com.daimeng.live.dialog.LiveCommon;
import com.daimeng.live.event.Event;
import com.daimeng.live.fragment.ChestBoxDialogFragment;
import com.daimeng.live.fragment.GiftListDialogFragment;
import com.daimeng.live.fragment.LiveRedEnvelopeNewDialog;
...
import com.daimeng.live.ui.customviews.SwipeAnimationController;
...
import com.daimeng.live.widget.LoadUrlImageView;
import com.daimeng.live.widget.VideoSurfaceView;
            ...
            runOnUiThread(new Runnable() {
                ...
                public void run() {
                    ...
                    LiveCommon.showConfirmDialog(RtmpPlayerActivity.this, "提示", getString(R.string.pay_time_msg, "1", mTimeBusiness.getmLiveCheckInfo().getType_val())
                            , new com.daimeng.live.interf.DialogInterface() {
                                @Override
