...
import com.tencent.liteav.demo.shortvideo.editor.word.widget.FloatTextProgressBar;
import com.tencent.liteav.demo.shortvideo.editor.word.widget.RangeSeekBar;
import com.tencent.liteav.demo.shortvideo.editor.word.widget.TCOperationViewGroup;
...
public class TCWordEditorFragment extends Fragment implements
    ...
    public void setVideoRangeTime(long startTime, long endTime) {
...
//        changeCurSelectedPos(pos);
    ...
    private void notifyOperationView(TCWordInfo info) {
        ...
        Log.d("edit_pressed", "index:" + index);
    ...
    private void changeCurSelectedPos(int pos) {
        ...
        if (mDuration != 0) {
            int leftIndex = (int) ((mWordInfoList.get(pos).getStartTime() - mStartTime) * 100 / mDuration);
            int rightIndex = (int) ((mWordInfoList.get(pos).getEndTime() - mStartTime) * 100 / mDuration);
...
//        stopPlay();
    ...
    public void onNewInputFinish(TCWordInfo info) {
        if (info != null) {
            ...
            long endTime = mStartTime + mDuration / 10;
     ...
     */
    private void showRelativeTime(long absoluteStartTime, long absoluteEndTime) {
